...
import Button, { GoogleBtnIcon, GoogleBtnText, LogoBtn } from "../components/SignIn/Button";
import SignInContainer, { BtnContainer, DividerContainer, SignInSectionLeft, SignInSectionRight } from '../components/SignIn/Container';
...
const SignIn = () => {
    ...
    const onSubmit = async (values: any) => {
        const { err, message, user } = await axios.post(`/users/auth/`, values).then(res => res.data);
        console.log(values);
        if (!err) {
            logIn(user);
            history.push('/');
    ...
    return (
        <SignInContainer>
            ...
            <SignInSectionRight>
                ...
                <div>
                    <DividerContainer>
                        <Divider><strong>Or</strong></Divider>
                    </DividerContainer>
                    <BtnContainer>
                        <LogoBtn type="button">
                            <GoogleBtnIcon>
